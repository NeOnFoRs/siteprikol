...
! function(jQuery, ytp) {
    jQuery.mbYTPlayer = {
            ...
            return this.each(function() {
                ...
                if (document.createElement("video").canPlayType && jQuery.extend(playerVars, {
                    ...
                    if (playerBox.css({
                            ...
                            opacity: 1
                        }), playerBox.after(overlay), YTPlayer.overlay = overlay, jQuery.isTablet && jQuery("body").one("touchstart", function() {
                    ...
                    if (console.debug(jQuery.mbBrowser.mobile, jQuery.isTablet, YTPlayer.canPlayOnMobile), jQuery.mbBrowser.mobile && !jQuery.isTablet && !YTPlayer.canPlayOnMobile) return YTPlayer.opt.mobileFallbackImage && wrapper.css({
                    ...
                    jQuery(document).on("YTAPIReady", function() {
                        YTPlayer.isBackground && ytp.backgroundIsInited || YTPlayer.isInit || (YTPlayer.isBackground && (ytp.backgroundIsInited = !0), YTPlayer.opt.autoPlay = "undefined" == typeof YTPlayer.opt.autoPlay ? YTPlayer.isBackground ? !0 : !1 : YTPlayer.opt.autoPlay, YTPlayer.opt.vol = YTPlayer.opt.vol ? YTPlayer.opt.vol : 100, jQuery.mbYTPlayer.getDataFromAPI(YTPlayer), jQuery(YTPlayer).on("YTPChanged", function() {
                            if (!YTPlayer.isInit) {
                                if (YTPlayer.isInit = !0, jQuery.mbBrowser.mobile && YTPlayer.canPlayOnMobile && !jQuery.isTablet) {
        ...
        getDataFromAPI: function(a) {
            ...
            }!a.isPlayer || a.opt.autoPlay || jQuery.mbBrowser.mobile || jQuery.isTablet || (a.loading = jQuery("<div/>").addClass("loading").html("Loading").hide(), jQuery(a).append(a.loading), a.loading.fadeIn())
        },
        ...
        checkForStart: function(a) {
            ...
            if (a.preventTrigger = !0, a.state = 2, jQuery(a).YTPPause(), jQuery(a).muteYTPVolume(), jQuery("#controlBar_" + a.id).remove(), a.controlBar = !1, a.opt.showControls && jQuery.mbYTPlayer.buildControls(a), a.overlay)
                if (a.opt.addRaster) {
            ...
            a.start_from_last = null, a.player.playVideo(), a.player.seekTo(d, !0), clearInterval(a.checkForStartAt), a.checkForStartAt = setInterval(function() {
                ...
                if (a.player.getDuration() > 0 && a.player.getCurrentTime() >= d && c) {
                    clearInterval(a.checkForStartAt),
                        "function" == typeof a.opt.onReady && a.opt.onReady(a), a.isReady = !0;
